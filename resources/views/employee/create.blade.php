<x-app-layout>
    ...
    <div class="sgx-title">
        <h1>
            <a href="{{route('employee.index')}}"><img src="{{asset('icons/arrow-left-blue.svg')}}" class="separate back"></a> {{$title}} 
        </h1>
    </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="sgx-w-300 input-td"><input type="text" name="name" required></td>
                    </tr>
                    <tr>
                        <td class="sgx-w-200 cell-title">NIK <small style="color: red">*</small></td>
                        <td class="sgx-w-300 input-td"><input type="text"  name="nik" required></td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="sgx-w-300 input-td"><input type="date" name="join_date" required></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="sgx-w-200 cell-title">Date of Birth</td>
                        <td class="sgx-w-300 input-td"><input type="date" name="date_of_birth"></td>
                        <td></td>
                    </tr>
                  </tbody>
                </table>
